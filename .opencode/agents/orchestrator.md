---
description: Orchestrates complex tasks by breaking them into small sequential steps, dispatching each step to a short-lived subagent, and discarding each subagent context before starting the next
mode: primary
temperature: 0.1
permission:
  edit: deny
