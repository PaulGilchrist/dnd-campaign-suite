...
describe('psionicStrikeHandler', () => {
    ...
    describe('hit trigger gate (CLA-273)', () => {
        ...
        it('fires after a qualifying weapon attack hit with exact math', async () => {
            ...
            expect(applyDamageToTarget).toHaveBeenCalledWith(expect.anything(), 'Target Goblin', 8, ['Force'], { campaignName: 'test-campaign', characters: [], ignoreResistance: false, attackerName: 'Test Fighter' });
