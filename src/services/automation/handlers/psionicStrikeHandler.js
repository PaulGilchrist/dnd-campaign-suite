...
export async function handle(action, playerStats, campaignName, _mapName) {
    ...
    return {
        ...
        payload: {
            ...
            description: `${action.name}: Deal <strong>${totalDamage}</strong> Force damage (Rolled ${psionicDieSize} for ${dieValue} + INT ${intMod}). Psionic Energy: ${currentUses - 1}/${defaultMax}.`,
            automation: auto,
        },
    };
}
