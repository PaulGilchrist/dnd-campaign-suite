...
describe('warMagicSpellHandler', () => {
    ...
    describe('confirmWarMagicSpell', () => {
        ...
        it('resolves Magic Missile auto-hit spell damage against the card target', async () => {
            ...
            expect(applyDamageToTarget).toHaveBeenCalledWith(combatSummary, 'Wight 1', 15, ['Force'], { campaignName: mockCampaignName, characters: [], ignoreResistance: false, attackerName: 'TestFighter' })
        ...
        it('grants and rolls one weapon attack against the same target on confirm', async () => {
            ...
            expect(applyDamageToTarget).toHaveBeenCalledWith(combatSummary, 'Wight 1', 5, ['Piercing'], { campaignName: mockCampaignName, characters: [], ignoreResistance: false, attackerName: 'TestFighter' })
