...
describe('auraDamageService — BUG CLA-170 persistence', () => {
  ...
  describe('applyHolyNimbusDamage', () => {
    it('computes CHA + PB radiant damage and applies it to the active enemy', async () => {
      ...
      expect(applyDamageToTarget).toHaveBeenCalledWith(expect.any(Object), 'Wight 1', 11, ['Radiant'], { campaignName: CAMPAIGN, characters: [paladin], ignoreResistance: false, attackerName: 'ElderPaladin' });
    });
