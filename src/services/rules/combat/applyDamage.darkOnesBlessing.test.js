...
describe('Dark One\'s Blessing', () => {
  ...
  it('grants temp HP equal to CHA modifier + warlock level when a creature dies', async () => {
    ...
    stubPlayerRuntime(0);
    await applyDamageToTarget(cs, 'Goblin', 10, ['Slashing'], { campaignName: 'TestCampaign', characters: [warlock, createMinimalCharacter('Goblin')], ignoreResistance: false, attackerName: null, suppressHpLog: false });
  ...
  it('uses Math.max instead of stacking temp HP', async () => {
    ...
    await applyDamageToTarget(cs, 'Goblin', 10, ['Slashing'], { campaignName: 'TestCampaign', characters: [warlock, warlock2, createMinimalCharacter('Goblin')], ignoreResistance: false, attackerName: null, suppressHpLog: false });
  ...
  it('does not grant temp HP when the feature is missing or lacks automation config', async () => {
    ...
    stubPlayerRuntime(0);
    await applyDamageToTarget(cs, 'Goblin', 10, ['Slashing'], { campaignName: 'TestCampaign', characters: [warlockNoFeature, createMinimalCharacter('Goblin')], ignoreResistance: false, attackerName: null, suppressHpLog: false });
    ...
    setRuntimeValue.mockClear();
    await applyDamageToTarget(cs, 'Goblin', 10, ['Slashing'], { campaignName: 'TestCampaign', characters: [warlockNoAutomation, createMinimalCharacter('Goblin')], ignoreResistance: false, attackerName: null, suppressHpLog: false });
  ...
  it('does not grant temp HP when the killing blow dealt 0 damage (immune)', async () => {
    ...
    await applyDamageToTarget(cs, 'Skeleton', 15, ['Necrotic'], { campaignName: 'TestCampaign', characters: [warlock, createMinimalCharacter('Skeleton')], ignoreResistance: false, attackerName: null, suppressHpLog: false });
  ...
  it('grants temp HP to each Fiend Patron warlock when multiple are present', async () => {
    ...
    stubPlayerRuntime(0);
    await applyDamageToTarget(cs, 'Goblin', 10, ['Slashing'], { campaignName: 'TestCampaign', characters: [warlock1, warlock2, createMinimalCharacter('Goblin')], ignoreResistance: false, attackerName: null, suppressHpLog: false });
