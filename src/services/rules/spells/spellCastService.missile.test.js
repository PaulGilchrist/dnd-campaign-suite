...
describe('executeSpellCast - Magic Missile', () => {
  ...
  describe('ignore_resistance passive', () => {
    it('passes ignoreResistance flag based on player passives', async () => {
      ...
      expect(applyDamage.applyDamageToTarget).toHaveBeenCalledWith(expect.anything(), 'Goblin', 15, ['Force'], { campaignName: 'testCampaign', characters: undefined, ignoreResistance: true, attackerName: 'TestWizard' })
    })
  })
