...
describe('createLogAndShow - Graze Damage', () => {
    ...
    describe('graze damage on miss', () => {
        it('applies graze damage when attack misses, grazeDamage is true, and grazeAbilityMod > 0', async () => {
            ...
            expect(applyDamageToTarget).toHaveBeenCalledWith(expect.any(Object), 'Goblin', 3, ['slashing'], { campaignName: expect.any(String), characters: expect.any(Array), ignoreResistance: false, attackerName: 'TestFighter' });
