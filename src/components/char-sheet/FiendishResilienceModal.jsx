            ...
            <div className="sp-overlay" onClick={onClose}>
                <div className="sp-modal" onClick={e => e.stopPropagation()}>
                    <div className="sp-header">
                        <i className="fa-solid fa-shield-halved"></i> {action?.name || 'Fiendish Resilience'}
                    </div>
            ...
            <div className="sp-modal" onClick={e => e.stopPropagation()}>
                ...
                <div className="sp-actions">
                    <button className="sp-roll-btn" onClick={handleApply} disabled={!selected}>
                        <i className="fa-solid fa-shield-halved"></i> {existingType ? 'Change Damage Type' : 'Choose Damage Type'}
                    </button>
...
export default FiendishResilienceModal;
