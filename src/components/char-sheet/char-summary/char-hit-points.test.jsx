...
describe('CharHitPoints', () => {
  ...
  it('should display max hit points', () => {
    ...
    const hpDiv = screen.getByText((content, element) => element.textContent.includes('Hit Points'));
    expect(hpDiv.parentElement.textContent).toContain('45');
   });
  ...
  it('should toggle input visibility when clicked', () => {
    ...
    const clickable = screen.getByText((content, element) => element.textContent.includes('Hit Points')).parentElement;
