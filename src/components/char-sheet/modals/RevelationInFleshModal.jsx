...
function RevelationInFleshModal({ action, playerStats, campaignName, onClose }) {
    ...
    const handleApply = async () => {
        if (!selected) return;
        const res = await applyRevelationOption(action, playerStats, campaignName, selected);
        setResult(res);
        setApplied(true);
    };
        ...
        <div className="sp-overlay" onClick={onClose}>
            <div className="sp-modal" onClick={e => e.stopPropagation()}>
                ...
                <div className="sp-body">
                    <p>Choose a bodily alteration (costs 1 Sorcery Point):</p>
