...
// ---------------------------------------------------------------------------
// Tests — Popup rendering: automation_info type
// ---------------------------------------------------------------------------

describe('popup rendering automation_info type', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockStore.clear();
  });

  it('renders the char-sheet wrapper and is ready for popup display', async () => {
  ...
  it('does not render a popup initially when popupHtml is null', async () => {
    render(<CharSheet {...defaultProps} />);
    await waitFor(() => {
      expect(screen.getByTestId('char-sheet')).toBeInTheDocument();
    });
...
// ---------------------------------------------------------------------------
// Tests — Popup rendering: empowered_spell type
// ---------------------------------------------------------------------------

describe('popup rendering empowered_spell type', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockStore.clear();
  });

  it('renders the char-sheet wrapper and is ready for empowered_spell popup display', async () => {
    render(<CharSheet {...defaultProps} />);
    await waitFor(() => {
      expect(screen.getByTestId('char-sheet')).toBeInTheDocument();
    });
  ...
  it('does not render a popup initially for empowered_spell type', async () => {
    render(<CharSheet {...defaultProps} />);
    await waitFor(() => {
      expect(screen.getByTestId('char-sheet')).toBeInTheDocument();
    });
  ...
  it('renders DiceRollResult popup when popupHtml has type other than automation_info or empowered_spell', async () => {
    render(<CharSheet {...defaultProps} />);
    await waitFor(() => {
      expect(screen.getByTestId('char-sheet')).toBeInTheDocument();
    });
...
// ---------------------------------------------------------------------------
// Tests — fanaticalFocusUsed reset on rage state change
// ---------------------------------------------------------------------------
