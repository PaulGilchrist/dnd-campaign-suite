...
vi.mock('./modals/CombatSuperiorityModal.jsx', () => ({
  default: function TestModal() { return <div data-testid="combat-superiority-modal">CombatSuperiorityModal</div>; },
}));
vi.mock('./modals/AttackRiderManeuverPrompt.jsx', () => ({
  default: function TestModal() { return <div data-testid="attack-rider-maneuver-prompt">AttackRiderManeuverPrompt</div>; },
}));
...
function createBaseProps(overrides) {
  return {
    ...
    handleBulwarkOfForceConfirm: vi.fn(),
    handleCoronaEnemySelectionConfirm: vi.fn(),
    handleRadianceOfDawnConfirm: vi.fn(),
...
describe('CharActionModals BulwarkOfForce, Corona, and Radiance modals', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
