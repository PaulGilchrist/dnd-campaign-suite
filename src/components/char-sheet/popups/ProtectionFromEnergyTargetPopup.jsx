...
export default function ProtectionFromEnergyTargetPopup({ spell, _playerStats, _campaignName, range, creatureTargets, damageTypes, onConfirm, onSkip }) {
        ...
        <div className="popup-overlay" onClick={onSkip}>
            <div className="popup-modal metamagic-popup" onClick={e => e.stopPropagation()}>
                <div className="metamagic-popup-inner">
                    <h3><i className="fa-solid fa-shield-halved"></i> Protection from Energy</h3>
