...
describe('CharActions base actions & popups', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    localStorage.clear();
  ...
  describe('damage click with save DC attack', () => {
    it('calls handleActionSpellDamageClick for save-based attacks', async () => {
      ...
      useActionSpellMetamagic.mockReturnValue({
        pendingActionMetamagic: null, handleActionMetamagicConfirm: vi.fn(), handleActionMetamagicSkip: vi.fn(),
        handleActionSpellDamageClick: mockHandleActionSpellDamageClick, handleSpellAttackClick: vi.fn(), handleSpellDamageClick: vi.fn(),
      });
