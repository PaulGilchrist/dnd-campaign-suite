...
function NoteModal({
  formData, editingNote, partyLevel, isLocalhost, saving, deleting,
  onClose, onFieldChange, onSave, onDelete,
}) {
      ...
      <div className="ct-modal notes-modal">
        ...
        <div className="ct-modal-body">
          ...
          <input
            ...
            onChange={(e) => onFieldChange('partyLocation', e.target.value)}
      ...
      {loading ? (
        ...
        <ul className="ct-list">
          {filteredNotes.map((note) => (
            <NoteListItem key={note.id} note={note} onEdit={handleEditNote} />
          ))}
        </ul>
      ) : (
        /* Empty state */
